...
URL = ctx.static_domain + "/script/plugins/uploads/";
...
//图片上传配置区
,imageUrl: ctx.fileUploadUrl + "/jsp/imageUp.jsp"           //图片上传提交地址
//,imagePath:URL + "jsp/"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
,imagePath:"/store/"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
//,imagePath:"/resources/upload/"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
